...
│                                                             │
│   daily 槽位 ← 日常聊天、主动消息、温和提醒                    │
│   deep  槽位 ← 深度情感对话、复杂回应、关键日记                │
│   backend 槽位 ← 打标、摘要、解锁文案、批量任务               │
│                                                             │
│   可选接入：                                                 │
│   · DeepSeek API    · 硅基流动    · 中转站                   │
│   · OpenAI 官方     · Anthropic（兼容代理）                  │
│   · Gemini Flash    · 本地兼容服务                           │
└─────────────────────────────────────────────────────────────┘
```
...
| **Google Fonts** | Cormorant Garamond + Instrument Sans | 两种字体，不多不少 |
...
| `backend` | 打标、摘要、解锁文案、批量任务 | 最便宜的能用的模型 | 极便宜 |
